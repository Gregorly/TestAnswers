...
namespace TestAnswers.AnswerMethods
{
    public static class Question9
    {
        ...
        {
            return $"I think that you have to use special strongly typed data types for numbers that are exponentially large such as " +
                ...
                $"is able to handle. I would make two general data types for digits that handles huge numbers, one would be signed and the other unsigned.";
        }
    }
}
